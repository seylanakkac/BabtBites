...
String effectiveRecipeCategory(Recipe r) {
  ...
  if (n.contains("çorba")) return "Çorbalar";
  if (n.contains("köfte")) return "Köfteler";
  if (n.contains("muhallebi") || n.contains("mama") || n.contains("puding")) return "Muhallebi ve Mama Tarifleri";
  if (n.contains("bisküvi") || n.contains("kurabiye") || n.contains("kraker")) return "Bisküviler";
  if (n.contains("pankek") || n.contains("krep") || n.contains("gözleme")) return "Pankek Tarifleri";
  if (n.contains("ekmek") || n.contains("kek") || n.contains("muffin")) return "Ekmekler";
  if (n.contains("çay")) return "Çaylar";
  if (n.contains("kahvalt") || n.contains("omlet") || n.contains("yulaf")) return "Kahvaltı";
  if (n.contains("püre") || n.contains("ezme")) return "Püreler";
  return "Diğer";
}
...
List<Recipe> _generateAllRecipes() {
  ...
  recipes.addAll([
    Recipe(
      id: "kofte1", name: "Fırında Tavuklu Sebzeli Köfte", category: "Köfteler",
    ...
    Recipe(
      id: "kofte2", name: "Buharda Hindi Köftesi", category: "Köfteler",
    ...
    Recipe(
      id: "kofte3", name: "Mercimekli Vejetaryen Köfte", category: "Köfteler",
    ...
    Recipe(
      id: "kofte4", name: "Fırında Somon Köftesi", category: "Köfteler",
    ...
    Recipe(
      id: "kofte5", name: "Patatesli Brokoli Köftesi", category: "Köfteler",
    ...
    Recipe(
      id: "kofte6", name: "Dana Kıymalı Mini Köfte", category: "Köfteler",
    ...
    Recipe(
      id: "kofte7", name: "Nohutlu Falafel Köftesi", category: "Köfteler",
    ...
    Recipe(
      id: "kofte8", name: "Kabaklı Peynirli Köfte", category: "Köfteler",
    ...
    Recipe(
      id: "kofte9", name: "Yulaflı Tavuk Köftesi", category: "Köfteler",
    ...
    Recipe(
      id: "kofte10", name: "Ispanaklı Lor Köftesi", category: "Köfteler",
    ...
    Recipe(
      id: "kofte11", name: "Bulgurlu Mercimek Köftesi (Vegan)", category: "Köfteler",
    ...
    Recipe(
      id: "kofte12", name: "Havuçlu Tavuk Köftesi", category: "Köfteler",
    ...
    Recipe(
      id: "kofte13", name: "Tatlı Patatesli Hindi Köftesi", category: "Köfteler",
      prepTime: "28 dk", startingMonth: 9, kcal: 135, imageUrl: "",
    ...
    Recipe(
      id: "kofte14", name: "Bezelyeli Pirinçli Köfte", category: "Köfteler",
      prepTime: "25 dk", startingMonth: 8, kcal: 110, imageUrl: "",
    ...
    Recipe(
      id: "kofte15", name: "Karnabaharlı Peynirli Köfte", category: "Köfteler",
      prepTime: "25 dk", startingMonth: 9, kcal: 105, imageUrl: "",
