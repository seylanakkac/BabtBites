...
final List<Food> globalFoodsDatabase = [
  ...
  Food(name: "Domates", emoji: "🍅", category: "Sebze", startingMonth: 6, allergyRisk: "Düşük", presentationStyles: {6: "Kabuk ve çekirdek ayıklanıp ezilir.", 9: "Küçük yumuşak parçalar.", 12: "Cherry domates dört parçaya bölünür."}, nutritionValues: {"Enerji": 18, "Protein": 0.9, "Sağlıklı Yağ": 0.2, "Demir": 0.3}, chokingRisk: "Yüksek", chokingNote: "Cherry/küçük domates ASLA bütün — boyuna ÇEYREKLENİR.", needsReview: true),
