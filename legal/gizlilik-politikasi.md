...
İşbu metinde geçen "biz", "Geliştirici" veya "BabyBites" ifadeleri **Seylan Akkaç**'ı; "siz" veya "Kullanıcı" ifadeleri Uygulama'yı kullanan kişiyi ifade eder.
...
Kişisel verilerinizle ilgili olarak; bilgi talep etme, düzeltme, silme, işlemeye itiraz ve verilerinizi taşıma haklarına sahipsiniz. Veriler yalnızca cihazınızda tutulduğundan, bu hakların çoğunu **doğrudan uygulama üzerinden** (düzenleme/silme) kullanabilirsiniz. Ek talepleriniz için bizimle iletişime geçebilirsiniz: **seylanakkac@gmail.com**.
